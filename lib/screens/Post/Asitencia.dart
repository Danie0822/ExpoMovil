...
// para mandar los datos de inasitencias 
  Future<void> _postData(String searchValue) async {
    ...
    final Map<String, dynamic> requestData = {
      ...
      'idDocente': id,
      'idTipoInasistencia': 1,
      'estado': 1
    };
    final Map<String, dynamic> requestNoti = {
      'idNotificacion': 1,
      'detalle': "Revisar Inasistencias",
    ...
    final response = await http.post(
      Uri.parse(
          'https://expo2023-6f28ab340676.herokuapp.com/Inasistencias/save'),
            ...
            return AlertDialog(
              ...
              content: Column(
                ...
                children: [
                  ...
                  const Text(
                    'La Inasistencia se envió correctamente.',
                    style: TextStyle(
                      color: Colors.black,
                      fontSize: 18,
                    ),
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: const Text(
              'Por favor, Esperar el envio de la Inasistencias',
              style: TextStyle(
                color: Colors.black,
                fontSize: 16,
              ),
